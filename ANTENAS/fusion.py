...
cursor.execute(sql_create_table_modo)
conexion.commit()

cursor.execute(sql_create_table_picking)
conexion.commit()

cursor.execute(sql_create_table_M1)
conexion.commit()

##################################################################################
#NO SÉ POR QUÉ PERO SI BORRAS ESTA SECCIÓN DEJA DE CORRER EL CÓDIGO CORRECTAMENTE#
##################################################################################
...
############
    ...
    try:
        cursor.execute("SELECT Estación_1 FROM modo ORDER BY id DESC LIMIT 1")
...
############
    ...
    try:
        cursor.execute("SELECT Estación_2 FROM modo ORDER BY id DESC LIMIT 1")
        modo = cursor.fetchone()[0]
    except Exception as e:
        modo = "No Armado"
...
############
    ...
    try:
        cursor.execute("SELECT Estación_3 FROM modo ORDER BY id DESC LIMIT 1")
        modo = cursor.fetchone()[0]
    except Exception as e:
        modo = "No Armado"
...
############
    ...
    try:
        cursor.execute("SELECT Estación_4 FROM modo ORDER BY id DESC LIMIT 1")
        modo = cursor.fetchone()[0]
    except Exception as e:
        modo = "No Armado"
...
############
    ...
    try:
        cursor.execute("SELECT Estación_5 FROM modo ORDER BY id DESC LIMIT 1")
        modo = cursor.fetchone()[0]
    except Exception as e:
        modo = "No Armado"
...
############
    ...
    try:
        cursor.execute("SELECT Estación_6 FROM modo ORDER BY id DESC LIMIT 1")
        modo = cursor.fetchone()[0]
    except Exception as e:
        modo = "No Armado"
